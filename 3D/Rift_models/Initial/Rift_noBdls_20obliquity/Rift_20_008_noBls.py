...
#Output Folder
Model.outputDir="outputs_Rift_20_1_noBls"
...
#                        XML="./ressources_riftM/badlands-20_2.xml", resolution=1. * u.kilometer,checkpoint_interval=0.05 * u.megayears,restartFolder="outbdls", restartStep=499)#,restartFolder="outbdls_20_2")
...
Model.run_for(30. * u.megayears,checkpoint_interval=0.05 * u.megayears,restartStep=516)
