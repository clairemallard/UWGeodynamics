...
half_rate = 0.2 * u.centimeter / u.year
...
#Output Folder
Model.outputDir="outputs_Rift_20_020_Bls"
...
Model.set_velocityBCs(front=[None, 0., None],
                      back=[None, 0., None],
                      left=[-0.2* u.centimeter / u.year, 0., None],
                      right=[0.2 * u.centimeter / u.year, 0., None],
...
XML="./ressources_riftM/badlands_20_05.xml", resolution=1. * u.kilometer,checkpoint_interval=0.05 * u.megayears,restartFolder="outbdls",restartStep=28)
...
## Temperature Boundary Condition
#Model.set_temperatureBCs(top=273.15 * u.degK, bottom=1523.15 * u.degK)
Model.set_temperatureBCs(top=273.15 * u.degK,nodeSets = [(air_shape, 273.15 * u.degK), (stickyAir_shape, 273.15 * u.degK)],
bottom=1523.15 * u.degK)
...
Model.run_for(40. * u.megayears,checkpoint_interval=0.05 * u.megayears,restartStep=28,restartDir="outputs_Rift_20_020_Bls")
