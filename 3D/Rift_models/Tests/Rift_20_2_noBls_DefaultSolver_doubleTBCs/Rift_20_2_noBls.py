...
#Output Folder
Model.outputDir="outputs_Rift_20_2_noBls-29-04-16"
...
#                                            XML="./ressources_riftM/badlands.xml", resolution=1. * u.kilometer,checkpoint_interval=0.05 * u.megayears)
...
Model.run_for(40. * u.megayears,checkpoint_interval=0.05 * u.megayears)#restartStep=52,
