...
#Output Folder
Model.outputDir="outputs_Rift_20_050_noBls_LowInitStrainRate"
...
Model.init_model(defaultStrainRate=5e-14 / u.second)

#Model.init(defaultStrainRate=5e-14 / u.second)
