...
half_rate = 0.75 * u.centimeter / u.year
...
#Output Folder
Model.outputDir="outputs_Rift_20_075_noBls_postSolve"
...
Model.set_velocityBCs(front=[None, 0., None],
                      back=[None, 0., None],
                      left=[-0.75* u.centimeter / u.year, 0., None],
                      right=[0.75 * u.centimeter / u.year, 0., None],
                      bottom=GEO.LecodeIsostasy(reference_mat=mantle,
                                                average=True),
                      order_wall_conditions=["front", "back", "left", "right", "bottom", "top"])
#Just commend post-solve if does not work!
