...
#Output Folder
Model.outputDir="outputs_Rift_20_2_Bls"
...
Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[stickyAir.index, air.index], sedimentIndex=sediment.index,
                        XML="./ressources_riftM/badlands-20_2.xml", resolution=1. * u.kilometer,checkpoint_interval=0.05 * u.megayears,restartFolder="outbdls",restartStep=95)#,restartFolder="outbdls_20_2")
...
Model.post_solve_function["B"] = post_hook
...
Model.run_for(40. * u.megayears,checkpoint_interval=0.05 * u.megayears,restartStep=95)
...
#Model.run_for(40. * u.megayears,restartStep=100,checkpoint_interval=0.05 * u.megayears)#restartStep=52,
