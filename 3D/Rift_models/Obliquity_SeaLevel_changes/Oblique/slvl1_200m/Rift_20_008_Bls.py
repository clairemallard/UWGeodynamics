...
Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[stickyAir.index, air.index],sedimentIndex=sediment.index, XML="./ressources_riftM/badlands-20_2.xml", resolution=1. * u.kilometer,checkpoint_interval=0.05 * u.megayears,restartFolder="outbdls",restartStep=510)
...
Model.run_for(30. * u.megayears,checkpoint_interval=0.05 * u.megayears,restartStep=510)
import sys
sys.exit()
