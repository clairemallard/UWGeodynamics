...
#
Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[stickyAir.index, air.index], sedimentIndex=sediment.index,XML="ressources/badlands_3.xml", resolution=1. * u.kilometer,restartFolder="outbdls",
...
Model.run_for(20.0* u.megayears,checkpoint_interval=0.05*u.megayears)
