...
Model.outputDir="CM_2cmyr_Reset3"
...
lowercrust.viscosity    = rh.Wet_Olivine_Dislocation_Goetze_et_al_1978
...
Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[stickyAir.index, air.index], sedimentIndex=sediment.index,XML="ressources/badlands_0.xml", resolution=1. * u.kilometer,restartFolder="outbdls", restartStep=24,checkpoint_interval=0.05 * u.megayears)  #restartFolder="outbdls", restartStep=131,
...
# # reload step
# Model.run_for(nstep=0, restartDir='./outputs/', restartStep=60)
#
# # ZERO things
...
Model.run_for(20. * u.megayears,restartDir='CM_2cmyr_Reset',restartStep=24,checkpoint_interval=0.05 * u.megayears)#restartStep=52,
