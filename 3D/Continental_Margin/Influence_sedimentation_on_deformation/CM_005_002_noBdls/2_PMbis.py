...
Model.outputDir="CM_2cmyr_Reset"
...
lowercrust.viscosity    = rh.Wet_Olivine_Dislocation_Goetze_et_al_1978#rh.Wet_Quartz_Dislocation_Goetze_et_al_1978
...
Model.set_velocityBCs(front=[None, 0., None],
                      back=[None, 0., None],
                      left=[-2.0 * u.centimeter / u.year, 0., None],
                      right=[0., 0. , None],
...
Model.surfaceProcesses = GEO.surfaceProcesses.Badlands(airIndex=[stickyAir.index, air.index], sedimentIndex=sediment.index,XML="ressources/badlands_0.xml", resolution=1. * u.kilometer,restartFolder="outbdls",checkpoint_interval=0.05 * u.megayears,restartStep=20)  
...
#Model.run_for(20.0* u.megayears,restartStep=55,checkpoint_interval=0.05*u.megayears)
# reload step
#Model.run_for(nstep=0, restartDir='./CM_5cmyr/', restartStep=20)
Model.run_for(20.0* u.megayears,checkpoint_interval=0.05*u.megayears,restartDir='./CM_5cmyr/',restartStep=20)
# ZERO things
...
# forward model with checkpointing
Model.run_for(nstep=1, checkpoint_interval=1)
Model.run_for(20. * u.megayears,restartStep=20,checkpoint_interval=0.05 * u.megayears)#restartStep=52,
